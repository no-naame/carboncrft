    ...
    return (
        <Magnetic intensity={0.3} springOptions={springOptions} actionArea="self" range={150}>
            <button
                ...
                className="group relative overflow-hidden px-10 py-4 rounded-full bg-white border  text-black font-medium tracking-wide transition-all duration-300 shadow-md"
            >
