...
const Logo = () => (
    <svg
        width="230.75"
        height="30.345733984266875"
        viewBox="0 0 350 46.02819889271249"
    ...
    >
        ...
        <g
            id="SvgjsG1753"
            featurekey="j5pGhi-0"
            transform="matrix(3.0349781442831913,0,0,3.0349781442831913,-3.1127801830816537,-13.159420554244466)"
            fill="currentColor"
        >
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA] relative overflow-hidden">
            ...
            <div className="fixed top-0 left-0 right-0 z-50 flex justify-center mx-8 mt-8">
                <div className="backdrop-blur-md bg-white/70 rounded-full px-12 py-4 border border-gray-200">
                    <Logo />
                </div>
            </div>

            {/* Main content */}
            <div className="flex flex-col md:flex-row border border-gray-200 rounded-2xl p-12 backdrop-blur-sm bg-white/80 h-[85vh] mx-5 mt-28">
                ...
                <div className="w-full md:w-1/2 flex items-center justify-center p-10">
                    <div className="max-w-xl text-center md:text-left">
                        <TextEffect
                            ...
                            per="char"
                            delay={0.5}
                            className="font-kontora font-extralight text-5xl sm:text-6xl md:text-8xl lg:text-9xl text-[#333333] headline-spacing mb-8"
                            variants={{
                                container: {
                                    hidden: { opacity: 0 },
                                    visible: {
                        ...
                        <TextEffect
                            per="char"
                            delay={2}
                            className="mt-8 font-kontora text-[#333333]/70 text-base tracking-wider text-center"
                            preset="blur"
                        >
                            Step 1 of 4
                        </TextEffect>
