...
function App() {
  ...
  return (
      <div className="min-h-screen bg-[#FAFAFA] relative overflow-hidden">
        ...
        {/* Main content */}
        <div className="flex border border-gray-200 rounded-2xl p-12 backdrop-blur-sm bg-white/80 h-[85vh] mx-5 mt-28">
          ...
          <div className="w-1/2 flex items-center justify-center p-10">
            <div className="max-w-xl">
              <TextEffect
                  ...
                  per="char"
                  delay={0.5}
                  className="font-kontora font-extralight text-7xl text-[#333333] headline-spacing mb-8"
                  variants={{
                    container: {
                      hidden: { opacity: 0 },
                      visible: {
              ...
              <TextEffect
                  per="word"
                  delay={1.5}
                  className="font-kontora text-xl text-[#333333]/70 mb-12 leading-relaxed"
                  preset="slide"
              >
              ...
              <TextEffect
                  per="char"
                  delay={2}
                  className="mt-8 font-kontora text-[#333333]/70 text-sm tracking-wider text-center"
                  preset="blur"
              >
                Step 1 of 4
              </TextEffect>
